...
public class ItemeEquipOutSidecr :BaseItemRender
{
	...
	void Awake ()
	{
		...
		text_EquipNamecr = cachedTransform.Find("text_EquipNamecr").GetComponent<Text>();
		text_EquipRricecr = cachedTransform.Find("text_EquipRricecr").GetComponent<Text>();
		image_EquipLineRightcr = cachedTransform.Find("image_EquipLineRightcr").GetComponent<Image>();
		image_EquipLineLeftcr = cachedTransform.Find("image_EquipLineLeftcr").GetComponent<Image>();
		image_EquipLineLinecr = cachedTransform.Find("image_EquipLineLinecr").GetComponent<Image>();
		image_EquipLineLine1cr = cachedTransform.Find("image_EquipLineLine1cr").GetComponent<Image>();
		//结束UI获取;
		isUIinit = true;
